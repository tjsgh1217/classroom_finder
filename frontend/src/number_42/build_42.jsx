...
const Build42 = () => {
  ...
  const availableRooms = ['420125', '420126', '420147'];
  ...
  const handleRoomClick = (roomId) => {
    const roomCode = `42${String(selectedFloor).padStart(2, '0')}${String(
      roomId
    ).padStart(2, '0')}`;
      ...
      <div className="content-wrapper">
        ...
        <div className="rooms-grid">
          {floorRoomNumbers[selectedFloor]?.map((roomId) => {
            const roomCode = `42${String(selectedFloor).padStart(
              2,
              '0'
            ...
            return (
              ...
              >
                ...
                <div className="room-name">
                  {`42${String(selectedFloor).padStart(2, '0')}${String(
                    roomId
                  ).padStart(2, '0')}`}
                </div>
                <div
