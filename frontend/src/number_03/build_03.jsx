...
const Build03 = () => {
  ...
  const handleRoomClick = (roomId) => {
    const roomCode = `03${String(selectedFloor).padStart(2, '0')}${String(
      roomId
    ).padStart(2, '0')}`;
      ...
      <div className="content-wrapper">
        ...
        <div className="rooms-grid">
          {floorRoomNumbers[selectedFloor]?.map((roomId) => {
            const roomCode = `03${String(selectedFloor).padStart(
              2,
              '0'
            ...
            return (
              ...
              >
                ...
                <div className="room-name">
                  {`03${String(selectedFloor).padStart(2, '0')}${String(
                    roomId
                  ).padStart(2, '0')}`}
                </div>
                <div
