...
const Build07 = () => {
  ...
  const floorRoomNumbers = {
    1: [1, 2, 3],
    2: [5, 6, 16],
    3: [1, 2, 3, 5, 6, 7, 8, 9, 20, 21, 22],
    4: [2, 3, 6, 12, 13, 15, 16, 22, 23, 24],
    5: [1, 2, 6, 8, 9, 10, 11, 12, 17, 18, 19],
  };
  ...
  const handleRoomClick = (roomId) => {
    const roomCode = `07${String(selectedFloor).padStart(2, '0')}${String(
      roomId
    ).padStart(2, '0')}`;
      ...
      <div className="content-wrapper">
        ...
        <div className="rooms-grid">
          {floorRoomNumbers[selectedFloor]?.map((roomId) => {
            const roomCode = `07${String(selectedFloor).padStart(
              2,
              '0'
            ...
            return (
              ...
              >
                ...
                <div className="room-name">
                  {`07${String(selectedFloor).padStart(2, '0')}${String(
                    roomId
                  ).padStart(2, '0')}`}
                </div>
                <div
