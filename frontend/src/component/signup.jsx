      ...
      <div className="signup-card">
        ...
        <form onSubmit={handleSubmit} className="signup-form">
          <div className="form-field">
            ...
            <div
              className={`input-container ${errors.studentId ? 'error' : ''}`}
            >
              <svg
            ...
            <div className="input-warning">
              ...
              <span>
                본인 학번이 아닐 경우 관리자에 의해 탈퇴될 수 있습니다.
              </span>
            </div>
          </div>
          ...
          <div className="form-field">
            ...
            >
              ...
              <button
                ...
                aria-label={
                  confirmPasswordVisible ? '비밀번호 숨기기' : '비밀번호 보기'
                }
              >
          ...
          <div className="form-field">
            ...
            <div
              className={`input-container ${errors.department ? 'error' : ''}`}
            >
              <svg
                className="input-icon"
                xmlns="http://www.w3.org/2000/svg"
                ...
                viewBox="0 0 16 16"
              >
                <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM1 8a7 7 0 0 1 7-7 3.5 3.5 0 1 1 0 7 3.5 3.5 0 1 0 0 7 7 7 0 0 1-7-7Z" />
              </svg>
              <input
                type="text"
                id="department"
