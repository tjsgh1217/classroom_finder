...
const Build50 = () => {
  ...
  const handleRoomClick = (roomId) => {
    const roomCode = `50${String(selectedFloor).padStart(2, '0')}${String(
      roomId
    ).padStart(2, '0')}`;
    ...
    <div className="building-container">
      ...
      <header className="building-header">
        <div className="header-content">
          <h1>{buildingId}번 건물 - 린튼클로벌비즈니스스쿨</h1>
        </div>
      </header>
      ...
      <div className="content-wrapper">
        ...
        <div className="rooms-grid">
          {floorRoomNumbers[selectedFloor]?.map((roomId) => {
            const roomCode = `50${String(selectedFloor).padStart(
              2,
              '0'
            ...
            return (
              ...
              >
                ...
                <div className="room-name">
                  {`50${String(selectedFloor).padStart(2, '0')}${String(
                    roomId
                  ).padStart(2, '0')}`}
                </div>
                <div
